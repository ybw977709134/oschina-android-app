...
public class UpdateManager {
	...
	private static final int DOWN_NOSDCARD = 0;//down_nosdcard
    private static final int DOWN_UPDATE = 1;//down_update
    private static final int DOWN_OVER = 2;//down_over
	
    private static final int DIALOG_TYPE_LATEST = 0;//type_latest
    private static final int DIALOG_TYPE_FAIL   = 1;//dialog_type_fall
